      ...
      <div>
        <ButtonToolbar>
          <ButtonGroup aria-label="Return Group">
            <Button onClick={this.returnToShowList} color="primary">
              <i className="fas fa-arrow-circle-left"></i> Show List
            </Button>
          </ButtonGroup>
          <ButtonGroup
            style={{marginLeft: 10}}
            aria-label="Slide-present Group">
            <Button variant="secondary" onClick={this.props.saveDB}>
              <i className="fas fa-save"></i>
            </Button>
            <DropdownButton as={ButtonGroup} title="Slide" variant="secondary">
              <Dropdown.Item onClick={this.props.insertSlide}>
                Insert Slide
              </Dropdown.Item>
              <Dropdown.Item onClick={this.props.insertQuiz}>
                Insert Quiz
              </Dropdown.Item>
              <Dropdown.Divider />
              <Dropdown.Item
            ...
            <Button variant="secondary" onClick={this.handlePresent}>
              Preview
            </Button>
          </ButtonGroup>
          <Settings
