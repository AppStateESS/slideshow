...
export default function Media(props) {
  ...
  return(
    <span>
      <Modal show={modalView} onHide={() => setModalView(false)} restoreFocus={false}>
      <Modal.Header closeButton>
        <span><h5>Show Preview Image</h5></span>
      </Modal.Header>
      <Modal.Body>
        <div className="card">
          ...
          <Dropzone
            ...
            onSubmit={(fileWithMeta) =>  {insertMedia(fileWithMeta); setModalView(false)}}
      ...
      <Tippy
        ...
        arrow={true}
      >
        <button className="tool" onClick={() => setModalView(true)}><i className="fas fa-image"></i></button>
      </Tippy>
    </span>
  )
}
