...
export default class QuizEdit extends Component {
	...
	save() {
		...
		form.append('correct', nqContent.correctAnswers)
		form.append('answers', nqContent.answers)
		form.append('question', nqContent.question)
		form.append('type', nqContent.questionType)
		form.append('id', window.sessionStorage.getItem('quizId'))
		console.log('execd')
		$.ajax({
			url: './slideshow/Quiz/' + window.sessionStorage.getItem('quizId'),
			type: 'put',
			data: form,
			processData: false,
			contentType: false,
